...
- "summary"：核心观点，纯 HTML（可用 <p>、<strong>、<ul><li>、<br>；不要 markdown/代码块标记），**按主题分 3 个小节**，每节以 <strong>小节标题</strong> 起头：
  1. <strong>🌐 外围环境</strong>：美联储利率/美债10Y/标普500/人民币汇率 对 A 股的影响（资金流/情绪/估值锚）
  2. <strong>🇨🇳 A股市场</strong>：A股走势 + 中国央行/LPR/M2/社融 + 中国经济（CPI/GDP）+ QVIX恐慌情绪 + 该市场风险与机会
  3. <strong>🥇 黄金</strong>：金价 + 实际利率/避险需求 + 该资产风险与机会
